      ...
      checked_structures: {
        dotaComponents: [
          ...
          },
          {
            ...
            name: "palette_underbrush",
            origin: [-4096, -3072, 128],
            palette: "radiant-underbrush",
            castShadows: false,
            placements: [
              { name: "a", variant: "bush-round", offset: [-384, 0, 0] },
              { name: "b", variant: "bush-wide", offset: [-128, 0, 0], scale: 1.1 },
              { name: "c", variant: "fern-a", offset: [128, 0, 0], yaw: 35 },
              { name: "d", variant: "grass-a", offset: [384, 0, 0], scale: [1, 0.9, 1.2] },
            ],
          },
          {
            kind: "staticPropPalette",
            name: "palette_wetland",
            origin: [-2048, -3072, 128],
            palette: "river-wetland",
            castShadows: false,
            placements: [
              { name: "a", variant: "cattails-a", offset: [-384, 0, 0] },
              { name: "b", variant: "cattails-b", offset: [-128, 0, 0] },
              { name: "c", variant: "cattails-c", offset: [128, 0, 0] },
              { name: "d", variant: "lily-pads", offset: [384, 0, 0] },
            ],
          },
          {
            kind: "staticPropPalette",
            ...
            castShadows: false,
            placements: [
              { name: "a", variant: "debris-a", offset: [-384, 0, 0] },
              { name: "b", variant: "chips-a", offset: [-128, 0, 0] },
              { name: "c", variant: "chips-b", offset: [128, 0, 0] },
              { name: "d", variant: "camp-ring", offset: [384, 0, 0] },
            ],
          },
          {
            kind: "staticPropPalette",
            name: "palette_cliffs",
            origin: [2048, -3072, 128],
            palette: "natural-cliffs",
            castShadows: false,
            placements: [
              { name: "a", variant: "rock-face-a", offset: [-384, 0, 0] },
              { name: "b", variant: "rock-face-b", offset: [-128, 0, 0] },
              { name: "c", variant: "wall-face-a", offset: [128, 0, 0] },
              { name: "d", variant: "wall-face-b", offset: [384, 0, 0] },
            ],
          },
          {
            kind: "staticPropPalette",
            ...
            castShadows: false,
            placements: [
              { name: "a", variant: "sticks-a", offset: [-384, 0, 0] },
              { name: "b", variant: "sticks-b", offset: [-128, 0, 0] },
              { name: "c", variant: "battle-a", offset: [128, 0, 0] },
              { name: "d", variant: "battle-b", offset: [384, 0, 0] },
            ],
          },
          {
