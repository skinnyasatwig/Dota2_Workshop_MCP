...
3. **Broader collision-aware preview (Research).** Add known prop/tree footprints so more engine-only blockers can be caught before launch. Checked player-clip footprints are already included.
