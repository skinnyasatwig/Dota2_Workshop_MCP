...
1. **Richer world geometry (Valve-format research).** Flat or per-corner-sloped convex/concave solid extrusions, flat/sloped convex gameplay volumes, segmented player-blocking walls, rectangular arches, checked navigation surfaces, bridge decks/approaches, and regular ring platforms with real central openings are safe. The practical ring case is compiler- and GridNav-proven through convex composition. Next, research arbitrary hole outlines, irregular arches, and curated decorative material composition without exposing unsafe triangle soup. The bridge fixture also proved that same-X/Y points at different heights alias in GridNav; do not promise independent stacked bridge and underpass routes unless a different Valve-supported representation is found.
