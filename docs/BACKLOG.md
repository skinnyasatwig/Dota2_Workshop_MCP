...
1. **Richer world geometry (Valve-format research).** Flat or per-corner-sloped convex/concave solid extrusions, flat/sloped convex gameplay volumes, segmented player-blocking wall outlines, and pre-compile material existence checks are safe. Next, add evidence-backed recipes for holes/arches, bridge walkability, and curated decorative material composition without exposing arbitrary unsafe triangle soup.
