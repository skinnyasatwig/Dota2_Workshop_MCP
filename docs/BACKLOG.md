...
1. **Richer world geometry (Valve-format research).** Flat or per-corner-sloped convex/concave solid extrusions, flat/sloped convex gameplay volumes, segmented player-blocking walls, rectangular and profile-driven arches, checked navigation surfaces, bridge decks/approaches, regular rings, and unequal-outline irregular holed platforms are safe. The practical ring case is compiler- and GridNav-proven; unequal hole boundaries and profile arches are compiler-proven through checked composition. Next, research multiple independent holes and curated decorative material composition without exposing unsafe triangle soup. True curves remain visual geometry rather than checked graybox surfaces. The bridge fixture also proved that same-X/Y points at different heights alias in GridNav; do not promise independent stacked bridge and underpass routes unless a different Valve-supported representation is found.
